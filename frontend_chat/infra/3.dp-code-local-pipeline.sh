...
RESOURCE_GROUP="ccb-chatbot"
LOCATION="East US"
REGISTRY_NAME="acrccbchatbot"
REGISTRY_LOGIN_SERVER="acrccbchatbot.azurecr.io"
IMAGE_VERSION=$(date +"%Y%m%d%H%M%S")
IMAGE_NAME="chatccbfrontend:$IMAGE_VERSION"
WEB_APP_NAME="waccbchatbot"
